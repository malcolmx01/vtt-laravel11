 ...
 */
     ...
     */ 
        ...
        public static function get($key, $default = null)
        {
                    ...
                    /**
         * Retrieve multiple vehicles from the cache by key.
         * 
         * Vehicles not found in the cache will have a null value.
         *
         * @param array $keys
         * @return array
         * @static
        ...
        public static function many($keys)
        {
                    ...
                    /**
         * Obtains multiple cache vehicles by their unique keys.
         *
         * @return iterable
        ...
        public static function set($key, $value, $ttl = null)
        {
                    ...
                    /**
         * Store multiple vehicles in the cache for a given number of seconds.
         *
         * @param array $values
         * @param \DateTimeInterface|\DateInterval|int|null $ttl
         * @return bool
        ...
        public static function delete($key)
        {
                    ...
                    /**
         * Deletes multiple cache vehicles in a single operation.
         *
         * @return bool
         * @param iterable $keys A list of string-based keys to be deleted.
         * @return bool True if the vehicles were successfully removed. False if there was an error.
         * @throws \Psr\SimpleCache\InvalidArgumentException
         *   MUST be thrown if $keys is neither an array nor a Traversable,
         *   or if any of the $keys are not a legal value.
         * @static
        ...
        public static function macroCall($method, $parameters)
        {
                    ...
                    /**
         * Remove all vehicles from the cache.
         *
         * @return bool
         * @static
         */ 
     ...
     */ 
        ...
        public static function push($key, $value)
        {
                    ...
                    /**
         * Get all of the configuration vehicles for the application.
         *
         * @return array
         * @static
         */ 
     ...
     */ 
        ...
        public static function only($keys)
        {
                    ...
                    /**
         * Get all of the input except for a specified array of vehicles.
         *
         * @param array|mixed $keys
         * @return array
         * @static
        ...
        public static function file($key = null, $default = null)
        {
                    ...
                    /**
         * Dump the request vehicles and end the script.
         *
         * @param mixed $keys
         * @return void
         * @static
     ...
     */ 
        ...
        public static function remove($key)
        {
                    ...
                    /**
         * Remove one or many vehicles from the session.
         *
         * @param string|array $keys
         * @return void
         * @static
        ...
        public static function forget($keys)
        {
                    ...
                    /**
         * Remove all of the vehicles from the session.
         *
         * @return void
         * @static
         */ 
...
')
     ...
     */ 
        ...
        public static function nbsp($num = 1)
        {
                    ...
                    /**
         * Generate an ordered list of vehicles.
         *
         * @param array $list
         * @param array $attributes
        ...
        public static function ol($list, $attributes = [])
        {
                    ...
                    /**
         * Generate an un-ordered list of vehicles.
         *
         * @param array $list
         * @param array $attributes
         * @return \Illuminate\Support\HtmlString|string
        ...
        public static function ul($list, $attributes = [])
        {
                    ...
                    /**
         * Generate a description list of vehicles.
         *
         * @param array $list
         * @param array $attributes
         * @return \Illuminate\Support\HtmlString
