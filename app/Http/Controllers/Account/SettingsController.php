...
use App\Http\Requests\Account\SettingsUserPasswordRequest;
...
class SettingsController extends Controller
{
    ...
    public function changeUserEmail(SettingsEmailRequest $request)
    {
        // prevent change email for demo account
        if ($request->input('current_email') === 'demo@demo.com') {
            return redirect()->intended('account/settings');
    ...
    public function changeUserPassword(SettingsUserPasswordRequest $request)
    {
        // prevent change password for demo account
        if ($request->input('current_email') === 'demo@demo.com') {
            return redirect()->intended('account/settings');
