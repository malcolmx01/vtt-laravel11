...
return array(
    ...
    'product' => array(
        'name'        => 'VTT',
        'description' => 'Vehicle Trip Ticket',
        'preview'     => 'https://deped.gov.ph/',
        'home'        => 'https://deped.gov.ph/',
        'purchase'    => 'https://deped.gov.ph/',
        'licenses'    => array(
            'terms' => 'https://deped.gov.ph/',
            'types' => array(
                array(
    ...
    // Meta
    'meta'    => array(
        'title'       => 'VTT - Vehicle Trip Ticket',
        'description' => 'Vehicle Trip Ticket - Department of Education',
        'keywords'    => 'VTT, Asset, Inventory, Procurement, Management',
        'canonical'   => 'https://deped.gov.ph/',
    ),

    // General
    'general' => array(
        'website'             => 'https://deped.gov.ph/',
        'about'               => 'https://deped.gov.ph/',
        'contact'             => 'mailto:jolex29@gmail.com',
        'support'             => 'https://deped.gov.ph/',
        'bootstrap-docs-link' => 'https://getbootstrap.com/docs/5.0',
        'licenses'            => 'https://deped.gov.ph/',
