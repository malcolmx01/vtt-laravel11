<x-auth-layout>
    ...
    <!--begin::Heading-->
        ...
        <div class="mb-10 bg-light-info p-8 rounded d-none"><div class="text-info"> Use account <strong></strong> and password <strong>demo</strong> to continue. </div></div>
        ...
        <div class="text-center">
            ...
            <!--begin::Separator-->
            <div class="d-none text-center text-muted text-uppercase fw-bolder mb-5">or</div>
            <!--end::Separator-->

            <!--begin::Google link-->
            <a href="{{ url('/auth/redirect/google') }}?redirect_uri={{ url()->previous() }}" class="d-none  btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
            ...
            <!--begin::Facebook link-->
            <a href="{{ url('/auth/redirect/facebook') }}?redirect_uri={{ url()->previous() }}" class="d-none  btn btn-flex flex-center btn-light btn-lg w-100 mb-5">
