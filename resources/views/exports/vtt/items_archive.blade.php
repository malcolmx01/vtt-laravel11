...
{{--NEW ITEM CODING--}}
{{--CONCATENATE(category_code,"-",classification_code,"-",sub_classification_code,"-",mid(descriptive_code,1,10),"-",size,"-",mid(color,1,4),”-“,mid(type,1,4),”-“,mid(brand,1,4),”-“,mid(model,1,4)
When those fields used in the formula are left BLANK, it is OK, it will just show “- -“ instead. Just like in the above sample, NO Brand (normally/usually) and NO Model were assigned.--}}
